...
export default function LandingPage() {
        ...
        <div className="relative w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 animate-fade-in">
          ...
          <ClerkLoading>
            <div className="h-[400px] flex flex-col items-center justify-center space-y-4">
              <div className="w-8 h-8 border-4 border-vintage-500 border-t-transparent rounded-full animate-spin"></div>
                ...
                <SignIn
                  appearance={{
                    ...
                    elements: {
                      ...
                      headerTitle: 'text-xl font-bold text-stone-800',
                      headerSubtitle: 'text-stone-500',
                      formButtonPrimary: 'bg-vintage-600 hover:bg-vintage-700 text-white !shadow-none rounded-xl',
                      socialButtonsBlockButton: 'border-stone-200 hover:bg-stone-50 rounded-xl',
                      formFieldInput: 'rounded-xl border-stone-200 focus:ring-vintage-500/20 focus:border-vintage-500',
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] text-stone-800 font-sans selection:bg-vintage-200 selection:text-vintage-900 overflow-x-hidden relative">
      
      {/* Background Ambience (Optimized for performance) */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-vintage-200/20 rounded-full blur-[120px] animate-breathe" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-stone-200/40 rounded-full blur-[120px] animate-breathe" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <nav className="fixed top-0 w-full z-40 px-6 py-6 transition-all duration-300">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-vintage-600 rounded-lg flex items-center justify-center shadow-lg shadow-vintage-500/20">
              <Sparkles className="w-4 h-4 text-white" />
            </div>
            <span className="text-lg font-bold tracking-tight text-stone-900">A.U.R.A</span>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-full text-sm font-medium bg-vintage-900/5 hover:bg-vintage-900/10 text-vintage-900 backdrop-blur-md border border-vintage-900/5 transition-all shadow-sm"
            >
              Get Started
            </button>
          </div>
      ...
      <main className="relative pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/60 border border-stone-200/60 backdrop-blur-md shadow-sm animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-vintage-500 animate-pulse"></span>
            <span className="text-xs font-bold tracking-widest text-stone-500 uppercase">System Online</span>
          </div>

          {/* Headline */}
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-stone-900 leading-[0.95] animate-slide-up">
            Not just smart. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-vintage-600 to-vintage-400 italic font-serif pr-2">Alive.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <button
              onClick={() => setShowAuth('signup')}
              className="group relative px-8 py-4 rounded-2xl bg-vintage-600/90 text-white font-medium text-lg shadow-xl shadow-vintage-500/20 hover:shadow-2xl hover:bg-vintage-600 hover:-translate-y-0.5 transition-all duration-300 backdrop-blur-md overflow-hidden"
            >
...
function FeatureCard({ icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <div className="p-8 rounded-3xl bg-white/40 border border-white/60 shadow-sm hover:shadow-md hover:bg-white/60 transition-all duration-300 backdrop-blur-sm group">
      <div className="w-12 h-12 rounded-2xl bg-white border border-stone-100 flex items-center justify-center text-vintage-600 mb-6 group-hover:scale-110 transition-transform duration-300 shadow-sm">
        {icon}
      </div>
